				...
				<div class="row">
					...
					<div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{ url('cms-pages/create/') }}" class="btn btn-primary default  btn-xl mb-2">{{ trans('global.add_cms_page') }}</a>
                                </div>
                            </div>						
                        </div>
                    </div>				
								  ...
								  @foreach($CmsPage as $key => $page)
									<tr data-user-id="{{ $page->id }}" class="user_row_{{$page->id}}" >
										...
										<td>
											...
											<a class="action" href ="{{url('cms-pages/edit/')}}/{{$page->id}}" title="Edit"><i class="simple-icon-note"></i></a>
