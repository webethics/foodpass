                                 ...
                                 <div class="profilehdr">
                                    <div class="profilelefthdr dashboardpfl_hdr">
                                       ...
                                       <div class="infohdr">
                                          ...
                                          <a href="tel:+1 85658 89562">{{ $user->mobile_number }}</a>
                                          <a href="mailto:johndoe@gmail.com">{{ $user->email }}</a>
                                       </div>
                                    </div>
                                    <div class="profilerighthdr">
                                       <a href="{{('/edit-profile-restaurant')}}" class="editbtn">Edit Profile</a>
                                    ...
                                    <div class="profilecont infocont">
                                       <div class="row">
                                          <div class="col-md-6 prof_info social_info">
                                             ...
                                             <p><span>Website </span><a href="#">{{ $user->website }}</a></p>
                                          </div>
                                          <div class="col-md-6 prof_info social_info">
                                             <img src="{{asset('frontend/images/socialicon3.svg')}}" />
                                             <p><span>Instagram </span><a href="#">{{ $user->instagram }}</a></p>
                                          </div>
                                          <div class="col-md-6 prof_info social_info">
                                             <img src="{{asset('frontend/images/socialicon2.svg')}}" />
                                             <p><span>Facebook </span><a href="#">{{ $user->facebook }}</a></p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
