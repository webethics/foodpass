	...
	@section('pageTitle','Add Postal Code')
	@section('content')
											  ...
											  <div class="infohdr editprofileinfo">
												 ...
												 <!--div class="row">
													<div class="col-md-6 form-group">
													   ...
													   <input name="post_code" id="post_code" placeholder="Postal Code"  class="form-control"  type="text">
													</div>
												 </div-->
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Delivery Range</label>
													   <input name="delivery_range" id="delivery_range" placeholder="Delivery Range" class="form-control delivery_range_store" type="text">
													</div>
												 </div>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Delivery Cost</label>
													   <input name="delivery_cost" id="delivery_cost" placeholder="Delivery Cost" class="form-control" type="text">
													</div>
												 </div>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Min Order Amount</label>
													   <input name="order_amount" id="order_amount" placeholder="Minium Order Amount" class="form-control" type="text">
													</div>
												 </div>
												 <div class="row">
