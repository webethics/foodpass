												 ...
												 <a href="javascript:void(0)" data-toggle="modal" data-target=".upload_photo_modal" class="show_image"  >
													<div class="circle">
														@if(auth::user()->profile_photo==NULL)
															<img class="profile-picture" src="{{asset('frontend/images/default_user.jpg')}}">
														@else
											  ...
											  <div class="infohdr editprofileinfo">
												 ...
												 <div class = "row">
													<div class="col-md-6 form-group">
													   ...
													   <input type="text" name = "restaurant_name" class="form-control" placeholder="" value="{{$user->restaurant_name}}" id="restaurant_name">
													</div>
													<div class="col-md-6 form-group">
													   <label>Delivery Costs	</label>
													   <input type="text" name = "delivery_cost" class="form-control" placeholder="" value="{{$user->delivery_cost}}" id="delivery_cost">
													</div>
												 </div>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Minimum order amount	</label>
													   <input type="text" name = "order_amount" class="form-control" placeholder="" value="{{$user->order_amount}}" id="order_amount">
													</div>
													<div class="col-md-6 form-group">
													   <label>Delivery Range (KM)</label>
													   <input type="text" name = "dilevery_range" class="form-control" placeholder="" value="{{$user->dilevery_range}}" id="dilevery_range">
													</div>
												 </div>
												 <h2>Social Links</h2>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Website</label>
													   <input type="url" name = "website" class="form-control" placeholder="" value="{{ $user->website }}" id="website">
													</div>
													<div class="col-md-6 form-group">
													   <label>Instagram</label>
													   <input type="url" name = "instagram" class="form-control" placeholder="" value="{{$user->instagram}}" id="instagram">
													</div>
												 </div>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Facebook</label>
													   <input type="url" name = "facebook" class="form-control" placeholder="" value="{{$user->facebook}}" id="facebook">
													</div>
												 </div>
												 <h2>Restaurant Menu</h2>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <input type="file" name="menu_file" id="menu_file" class="inputfile" accept=".pdf,.doc,.docx"/>
													   <label for="menu_file"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"></path></svg> <span>Choose a file…</span></label>
													   @php
													   $class = "none";
													   @endphp
													   ...
													   @php
														$class = "block";
														$menu_url =  store_menu(auth::user()->id);
														@endphp   
													   @endif
													   
														<div class="new-pdf-file"style="display:{{$class}}">
															<img src="{{asset('frontend/images/document.png')}}" height="50" width="50"> 
															@if(isset($menu_url))
															<a href = "{{$menu_url}}" download style="opacity:1;"><span id="pdf_file_name">{{$user->menu_file}}</span></a>
															@else
												 ...
												 <div class="row">
													<div class="col-md-12 editbtn">
													   <input type="submit" onclick="submitrestaurantprofile(event);" class="btn" value="Update" />
													</div>
												 </div>
											  </div>
										   </div>
