	...
	@section('pageTitle','Edit Postal Code')
	@section('content')
							...
							<div class="col storeprofilecol">
							   <div class="profilerow pt-2">
								  <div class="profileinfo">
									 ...
									 <form class="editprofileform password_form" action = "{{ url('save-post-code')}}" method="post" enctype="multipart/form-data">
										{{ csrf_field() }}
										<input type = "hidden" name="unique_postal_id" id="unique_postal_id" value= "{{ $postal->id }}"  />
											  ...
											  <div class="infohdr editprofileinfo">
												 ...
												 <!--div class="row">
													<div class="col-md-6 form-group">
													   ...
													   <input name="post_code" id="post_code" placeholder="Postal Code"  class="form-control"  type="text" value = "{{ $postal->post_code }}">
													</div>
												 </div-->
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Delivery Range</label> 
													   <input name="delivery_range" id="delivery_range" placeholder="Delivery Range" class="form-control delivery_range_store" type="text" value = "{{ $postal->delivery_range }}">
													</div>
												 </div>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Delivery Cost</label>
													   <input name="delivery_cost" id="delivery_cost" placeholder="Delivery Cost" class="form-control" type="text" value = "{{ $postal->delivery_cost }}">
													</div>
												 </div>
												 <div class="row">
													<div class="col-md-6 form-group">
													   <label>Min Order Amount</label>
													   <input name="order_amount" id="order_amount" placeholder="Minium Order Amount" class="form-control" type="text" value = "{{ $postal->order_amount}}">
													</div>
												 </div>
												 <div class="row">
													<div class="col-md-12 editbtn">
													   <input type="submit" class="btn" onclick="location_submit(event);" value="Save" />
													</div>
												 </div>
											  </div>
										   </div>
