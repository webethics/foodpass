...
class CmsController extends Controller
{
	...
	*/
    public function index()
    {
		...
		$CmsPage =  CmsPage::all();
        return view('cms.index',compact('CmsPage'));
    }
	...
	*/
	public function cms_page_edit($id){
		...
		//display edit page of email template
			...
			return view('cms.edit_page' , compact('result'));
	}

	public function cms_page_create(){
		return view('cms.create_page' , compact('result'));
	}
	...
	public function cms_page_update(CreatePageRequest $request){
		...
		return redirect('cms-pages/edit/'.$page_id); 
